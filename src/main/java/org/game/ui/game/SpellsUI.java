...
public class SpellsUI {
    public static void setupSpellsUI(JPanel panel, Character character, Enemy enemy, CardLayout cardLayout) {
        ...
        for (int i = 0; i < placeholdersNeeded; i++) {
            ...
            panel.add(placeholder); // Add placeholder to maintain grid size
        }
    }
}
